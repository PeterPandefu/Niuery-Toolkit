...
- **最近使用** — 自动记录使用历史
- **系统托盘** — 最小化到托盘，支持开机自启
- **截图识文** — 截图后识别图中文字（本地 OCR），支持框选局部识别，一键跳转翻译
- **外观皮肤** — 4 款皮肤（锻造 / 海洋 / 森林 / 极简）搭配深色/浅色主题，跟随系统自动切换
- **中英双语**，自动检测浏览器语言
- **统一日志系统**，所有工具操作可追溯
...
| 思维导图 | 离线思维导图：本地 .smm 保存、Markdown 导入、PNG / SVG 导出 |
...
| 工具 | 说明 |
| --- | --- |
| 翻译 | 百度翻译集成，多语种互译，自动检测源语言，目标语言支持自动选择 |
